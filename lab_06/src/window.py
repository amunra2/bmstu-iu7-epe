...
class Window(QMainWindow):
    ...
    def resizeTables(self):
        self.ui.budgetTable.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
        self.ui.budgetTable.verticalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)

        self.ui.projectTable.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
        self.ui.projectTable.verticalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
